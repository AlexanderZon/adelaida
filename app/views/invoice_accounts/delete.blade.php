			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i>Eliminación de Cuentas de Facturas
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<form action="" method="post" class="form-horizontal">
							<div class="form-body">
								<h3 >¿Desea eliminar la Cuenta <em>{{ $invoice_account->name }}</em>?</h3>
								<input type="hidden" name="id" value="{{ $invoice_account->id }}"/>
								<!--/row-->
							</div>
