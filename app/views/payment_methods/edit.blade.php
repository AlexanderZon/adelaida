		...
		<div class="page-head">
			...
			<div class="page-toolbar">
				...
				<div class="btn-group btn-theme-panel">
					<a href="{{ $module['route'] }}" class="btn tooltips" data-toggle="Añadir un nuevo registro" data-container="body" data-placement="left" data-html="true"  data-original-title="Volver al Listado de Métodos de Pago"><i class="icon-arrow-left"></i></a>
				</div>
				<!-- END THEME PANEL -->
			</div>
			<!-- END PAGE TOOLBAR -->
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-credit-card"></i>Edición de Mètodos de Pago
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<form action="" method="post" class="form-horizontal">
							<div class="form-body">
								<h3 class="form-section">Información de Método de Pago</h3>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3">Título</label>
											<div class="col-md-9">
												<input name="name" type="text" class="form-control" placeholder="Ingrese el título de la Método de Pago" value="{{ $payment_method->name }}" required>
									...
									<div class="col-md-6">
										<div class="form-group {{ false ? 'has-error' : '' }}">
											...
											<div class="col-md-9">
												<input name="description" type="text" class="form-control" placeholder="Ingrese la Descripción de la Método de Pago" value="{{ $payment_method->description }}">
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
