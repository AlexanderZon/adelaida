				...
				<div class="col-md-12">
					<div class="portlet box green-haze" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-send-o"></i> Editar Proyecto - <span class="step-title">
								Paso 1 de 4 </span>
							</div>
											...
											<div class="tab-pane" id="tab2">
															...
															<!-- <div class="input-group "> -->
																...
																<select id="id_client" name="id_client" class="form-control select2me" required>
																	...
																	@foreach( $clients as $client )
																		<option value="{{ $client->id }}" {{ $project->sale_order->id_client ==  $client->id ? 'selected' : '' }}>{{ $client->name }} ({{ $client->identification_number }})</option>
																	@endforeach
																</select>
															<!-- </div> -->
														</div>
															...
															<!-- <div class="input-group "> -->
																...
																<select id="id_seller" name="id_seller" class="form-control select2me" required>
																	...
																	@foreach( $sellers as $seller )
																		<option value="{{ $seller->id }}" {{ $project->sale_order->id_seller ==  $seller->id ? 'selected' : '' }}>{{ $seller->first_name }} {{ $seller->last_name }} ({{ $seller->displayname }})</option>
																	@endforeach
																</select>
															<!-- </div> -->
														</div>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-4">
														<input type="text" class="form-control" name="correlative" value="{{ $project->sale_order->correlative }}"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-4">
														<input type="text" class="form-control date-picker" name="date"value="{{ date('d/m/Y', strtotime($project->sale_order->date)) }}"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-4">
														<input type="text" placeholder="" class="form-control" name="period_days" value="{{ $project->sale_order->period_days }}"/>
														<span class="help-block">
														</span>
													</div>
												</div>
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-4">
														<div class="input-group">
															<input type="text" placeholder="" class="form-control" name="budget" value="{{ $project->sale_order->budget }}"/>
