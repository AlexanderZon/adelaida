		...
		<div class="page-head">
			...
			<div class="page-toolbar">
				...
				<div class="btn-group btn-theme-panel">
					<a href="{{ $module['route'] }}" class="btn tooltips" data-toggle="Añadir un nuevo registro" data-container="body" data-placement="left" data-html="true"  data-original-title="Volver al Listado de Proveedores"><i class="icon-arrow-left"></i></a>
				</div>
				<!-- END THEME PANEL -->
			</div>
			<!-- END PAGE TOOLBAR -->
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-key"></i>Edición de Proveedores
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<form action="" method="post" class="form-horizontal">
							<div class="form-body">
								<h3 class="form-section">Información de Proveedores</h3>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3">Nombre</label>
											<div class="col-md-9">
												<input name="name" type="text" class="form-control" placeholder="Ingrese el título de la Proveedores" required value="{{ $provider->name }}">
									...
									<!--/span-->
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'providers_identification_err' ? 'has-error' : '' }}">
											<label class="control-label col-md-3">RIF</label>
											<div class="col-md-9">
												<input name="identification_number" type="text" class="form-control" placeholder="Ingrese la RIF de la Proveedores" required value="{{ $provider->identification_number }}">
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input name="email" type="email" class="form-control" placeholder="Ingrese el Email de la Proveedores" required value="{{ $provider->email }}">
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group {{ false ? 'has-error' : '' }}">
											...
											<div class="col-md-9">
												<input name="phone" type="text" class="form-control" placeholder="Ingrese el Teléfono de la Proveedores" required value="{{ $provider->phone }}">
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group" id="form-group-representant">
											...
											<div class="col-md-9">
								            	...
								            	<input class="form-control" type="hidden" name="id_person" readonly required value="{{ $provider->representant->id }}">
								            	<div id="form-display-representant" style="font-size:12pt;padding-top:3px;">
								            		<span id="form-display-representant-span">{{ $provider->representant->identification_number }} - {{ $provider->representant->first_name }} {{ $provider->representant->last_name }}</span>
									...
									<!--/span-->
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'providers_location_err' ? 'has-error' : '' }}" id="form-group-location">
												...
												<div class="input-group ">
													...
													<select name="id_location" class="form-control select2me" data-placeholder="Seleccione una localidad..." required>
														...
														@foreach( $locations as $location )
															<option value="{{ $location->id }}" {{ $provider->location->id == $location->id ? 'selected' : '' }}>{{ $location->name }}</option>
														@endforeach
													</select>
												</div>
											</div>
