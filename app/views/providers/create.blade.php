			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i>Creación de Proveedores
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<form id="form-validate" action="" method="post" class="form-horizontal">
							<div class="form-body">
								<h3 class="form-section">Información de Proveedor</h3>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label col-md-3">Nombre</label>
											<div class="col-md-9">
												<input name="name" type="text" class="form-control" placeholder="Ingrese el título de la Proveedor" required>
									...
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'clients_identification_err' ? 'has-error' : '' }}">
											...
											<div class="col-md-9">
												<input name="identification_number" type="text" class="form-control" placeholder="Ingrese la RIF de la Proveedor" required>
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input name="email" type="email" class="form-control" placeholder="Ingrese el Email de la Proveedor" required>
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group {{ false ? 'has-error' : '' }}">
											...
											<div class="col-md-9">
												<input name="phone" type="text" class="form-control" placeholder="Ingrese el Teléfono de la Proveedor" required>
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
