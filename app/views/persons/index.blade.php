				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-male"></i>Listado de Personas
							</div>
							<div class="tools">
								@if(Auth::user()->hasCap('persons_create_get'))
						...
						<div class="portlet-body">
							...
							<tr>
								...
								@if(Auth::user()->hasCap('persons_show_get') OR Auth::user()->hasCap('persons_edit_get') OR Auth::user()->hasCap('persons_delete_get'))
									<th>
										 Acciones
									</th>
								@endif
							...
							<tr>
								...
								@if(Auth::user()->hasCap('persons_show_get') OR Auth::user()->hasCap('persons_edit_get') OR Auth::user()->hasCap('persons_delete_get'))
									<td>
										@if(Auth::user()->hasCap('persons_show_get'))
											&nbsp;&nbsp;
											<a class="font-blue-steel tooltips" href="{{ $module['route'] . '/show/' . Crypt::encrypt($persona->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Visualizar"> <i class="fa fa-eye"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('persons_edit_get'))
											&nbsp;&nbsp;
											<a class="font-yellow-crusta tooltips" href="{{ $module['route'] . '/edit/' . Crypt::encrypt($persona->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Editar"> <i class="fa fa-pencil"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('persons_delete_get'))
											&nbsp;&nbsp;
											<a class="font-red-sunglo tooltips" href="{{ $module['route'] . '/delete/' . Crypt::encrypt($persona->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Eliminar"> <i class="fa fa-trash-o"></i> </a>
										@endif
									</td>
								@endif
