								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group {{ false ? 'has-error' : '' }}">
											...
											<div class="form-control-static col-md-9">
												<span>{{ $request->stock->description != '' ? $request->stock->description : '<em>Sin Descripción</em>' }}</span>
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
								...
								<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="input-icon right">
													...
													<input id="units" name="units" type="number" class="form-control" placeholder="Ingrese el nombre para mostrar" value="{{ $request->units }}" min="0">
													<span class="help-block" style="display:none"> <i class="fa fa-warning"></i> Si se requiere una cantidad de request mayor al que esta en stock deberá crear la solicitud de dicho request en la seccion de Stock. </span>
												</div>
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									...
									<div class="col-md-6">
										<div class="form-group {{ false ? 'has-error' : '' }}">
											...
											<div class="form-control-static col-md-9">
												<span id="quantity">{{ $request->stock->units }}</span> <span id="measurement_unit">{{ $request->stock->measurement_unit->symbol }}</span>
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
