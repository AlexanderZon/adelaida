			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i>Eliminación de Unidades de Medida
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<form action="" method="post" class="form-horizontal">
							<div class="form-body">
								<h3 >¿Desea eliminar la unidad de medida {{ $measurement_unit->name }} (<em>{{ $measurement_unit->symbol }}</em>)?</h3>
								<input type="hidden" name="id" value="{{ $measurement_unit->id }}"/>
								<!--/row-->
							</div>
