					...
					<div class="portlet box green-haze">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								@if(Auth::user()->hasCap('measurement_units_show_get') OR Auth::user()->hasCap('measurement_units_edit_get') OR Auth::user()->hasCap('measurement_units_delete_get'))
									<th>
										 Acciones
									</th>
								@endif
							...
							<tr>
								...
								<td>
									{{ $measurement_unit->route }}
								</td> -->
								@if(Auth::user()->hasCap('measurement_units_show_get') OR Auth::user()->hasCap('measurement_units_edit_get') OR Auth::user()->hasCap('measurement_units_delete_get'))
									<td>
										@if(Auth::user()->hasCap('measurement_units_show_get'))
											&nbsp;&nbsp;
											<a class="font-blue-steel tooltips" href="{{ $module['route'] . '/show/' . Crypt::encrypt($measurement_unit->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Visualizar"> <i class="fa fa-eye"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('measurement_units_edit_get'))
											&nbsp;&nbsp;
											<a class="font-yellow-crusta tooltips" href="{{ $module['route'] . '/edit/' . Crypt::encrypt($measurement_unit->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Editar"> <i class="fa fa-pencil"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('measurement_units_delete_get'))
											&nbsp;&nbsp;
											<a class="font-red-sunglo tooltips" href="{{ $module['route'] . '/delete/' . Crypt::encrypt($measurement_unit->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Eliminar"> <i class="fa fa-trash-o"></i> </a>
										@endif
									</td>
								@endif
