							...
							<tr>
								...
								<td>
									@if( $user->status == 'active' )
										<span class="label bg-blue">{{ 'Activo' }}</span>
									@elseif( $user->status == 'inactive' )
										<span class="label bg-yellow-saffron">{{ 'Inactivo' }}</span>
									@elseif( $user->status == 'trash' )
										<span class="label bg-red-sunglo">{{ 'Eliminado' }}</span>
									@endif
								</td>
								<td>
									&nbsp;&nbsp;
									<a class="font-blue-steel" href="{{ $module['route'] . '/' . Crypt::encrypt($user->id) . '/show' }}"> <i class="fa fa-eye"></i> </a> 
									&nbsp;&nbsp;
									<a class="font-yellow-crusta" href="{{ $module['route'] . '/' . Crypt::encrypt($user->id) . '/edit' }}"> <i class="fa fa-pencil"></i> </a> 
									&nbsp;&nbsp;
									<a class="font-red-sunglo" href="{{ $module['route'] . '/' . Crypt::encrypt($user->id) . '/delete' }}"> <i class="fa fa-trash-o"></i> </a>
								</td>
							</tr>
							@endforeach
							</tbody>
