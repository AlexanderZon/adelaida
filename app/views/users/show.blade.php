	...
	<div class="profile-sidebar col-md-2" >
		...
		<div class="portlet light profile-sidebar-portlet">
			...
			<div class="profile-userbuttons">
				<a href="{{ $module['route'] }}/edit/{{ Crypt::encrypt($user->id) }}" type="button" class="btn btn-circle green-haze btn-sm">Editar</a>
				<a href="{{ $module['route'] }}/delete/{{ Crypt::encrypt($user->id) }}" type="button" class="btn btn-circle btn-danger btn-sm">Eliminar</a>
			</div>
			<!-- END SIDEBAR BUTTONS -->
			<!-- SIDEBAR MENU -->
