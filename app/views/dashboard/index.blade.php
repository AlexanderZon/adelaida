		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat2">
					<div class="display">
						<div class="number">
							<h3 class="font-green-sharp"><span class="currency">{{ $incomes['concreted'] }}</span> <small class="font-green-sharp">Bs.</small></h3>
					...
					<div class="progress-info">
						<div class="progress">
							<span style="width: {{ $incomes['percentage'] }}%;" class="progress-bar progress-bar-success green-sharp">
							<span class="sr-only"><span class="currency">{{ $incomes['received'] }}</span> Bs. Recibidos</span>
							</span>
						</div>
						<div class="status">
							<div class="status-title">porcentaje adquirido</div>
							<div class="status-number">{{ $incomes['percentage'] }}%</div>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="row list-separated">
							<div class="col-md-3 col-sm-3 col-xs-6">
								...
								<div class="uppercase font-hg font-green">
									<span class="currency">{{ $incomes['received'] }}</span> <span class="font-lg font-grey-mint">Bs.</span>
								</div>
							</div>
							<div class="col-md-3 col-sm-3 col-xs-6">
								<div class="font-grey-mint font-sm">
								...
								<div class="uppercase font-hg theme-font-color">
									<span class="currency">{{ $incomes['concreted'] }}</span> <span class="font-lg font-grey-mint">Bs.</span>
								</div>
							</div>
							<div class="col-md-3 col-sm-3 col-xs-6">
								<div class="font-grey-mint font-sm">
