		...
		<div class="page-head">
			...
			<div class="page-toolbar">
				...
				<div class="btn-group btn-theme-panel">
					@if(Auth::user()->hasCap('categories_create_get'))
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-key"></i>Listado de Categorias
							</div>
							<div class="tools">
								@if(Auth::user()->hasCap('categories_create_get'))
						...
						<div class="portlet-body">
							...
							<tr>
								...
								@if(Auth::user()->hasCap('categories_show_get') OR Auth::user()->hasCap('categories_edit_get') OR Auth::user()->hasCap('categories_delete_get'))
									<th>
										 Acciones
									</th>
								@endif
							...
							<tr>
								...
								@if(Auth::user()->hasCap('categories_show_get') OR Auth::user()->hasCap('categories_edit_get') OR Auth::user()->hasCap('categories_delete_get'))
									<td>
										@if(Auth::user()->hasCap('categories_show_get'))
											&nbsp;&nbsp;
											<a class="font-blue-steel tooltips" href="{{ $module['route'] . '/show/' . Crypt::encrypt($category->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Visualizar"> <i class="fa fa-eye"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('categories_edit_get'))
											&nbsp;&nbsp;
											<a class="font-yellow-crusta tooltips" href="{{ $module['route'] . '/edit/' . Crypt::encrypt($category->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Editar"> <i class="fa fa-pencil"></i> </a> 
										@endif
										@if(Auth::user()->hasCap('categories_delete_get'))
											&nbsp;&nbsp;
											<a class="font-red-sunglo tooltips" href="{{ $module['route'] . '/delete/' . Crypt::encrypt($category->id) }}" data-container="body" data-placement="bottom" data-html="true"  data-original-title="Eliminar"> <i class="fa fa-trash-o"></i> </a>
										@endif
									</td>
								@endif
