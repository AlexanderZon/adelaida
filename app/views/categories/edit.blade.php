								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-md-9">
												<input name="name" type="text" class="form-control" placeholder="Ingrese el título de la Categoría" value="{{ $category->name }}" required>
									...
									<div class="col-md-6">
										<div class="form-group {{ false ? 'has-error' : '' }}">
											...
											<div class="col-md-9">
												<input name="description" type="text" class="form-control" placeholder="Ingrese la Descripción de la Categoría" value="{{ $category->description }}">
												<!-- <span class="help-block">This is inline help</span> -->
											</div>
										</div>
									</div>
