			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-cubes"></i>Edición de Item de Stock
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<form action="" method="post" class="form-horizontal">
							<div class="form-body">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'category_email_err' ? 'has-error' : '' }}">
											<label class="control-label col-md-3">Nombre</label>
											<div class="col-md-9">
												<input name="name" type="text" placeholder="Ingrese el Nombre del Item" class="form-control" value="{{ $item->name }}" required>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'category_category_err' ? 'has-error' : '' }}">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'category_email_err' ? 'has-error' : '' }}">
											...
											<div class="col-md-9">
												<input name="units" type="number" min="0" placeholder="Ingrese las unidades en Stock" class="form-control" value="{{ $item->units }}" required>	
											</div>
										</div>
									</div>
									<div class="col-md-6">
												...
												<div class="input-group ">
													...
													<select name="id_measurement_unit" class="form-control select2me" data-placeholder="Seleccione una unidad de medida..." required>
														...
														@foreach( $measurement_units as $measurement_unit )
															@if( $item->measurement_unit->id == $measurement_unit->id)
																<option value="{{ $measurement_unit->id }}" selected>{{ $measurement_unit->name }} ({{ $measurement_unit->symbol }})</option>
															@else
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group {{ $module['msg_warning']['name'] == 'category_categoryname_err' ? 'has-error' : '' }}">
											<label class="control-label col-md-3">Descripción</label>
											<div class="col-md-9">
												<div class="input-icon right">
													<i class="fa fa-category"></i>
													<textarea name="description" type="text" class="form-control" placeholder="Ingrese el nombre del Usuario">{{ $item->description }}</textarea>
												</div>
